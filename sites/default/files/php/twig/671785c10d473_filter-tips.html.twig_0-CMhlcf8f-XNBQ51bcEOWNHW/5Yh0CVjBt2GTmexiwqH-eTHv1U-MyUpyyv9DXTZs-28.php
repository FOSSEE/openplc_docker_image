...
class __TwigTemplate_4a519a711f09806171354b9132798793 extends Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . Twig\Extension\CoreExtension::replace($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/seven/templates/classy/content-edit/filter-tips.html.twig", "/var/www/html/openplc_10/themes/contrib/seven/templates/classy/content-edit/filter-tips.html.twig");
    }
